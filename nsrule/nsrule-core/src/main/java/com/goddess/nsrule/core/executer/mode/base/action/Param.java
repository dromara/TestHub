...
public class Param extends BaseDataPo {
    ...
    private static Object getData(Param param ,Object data){
        switch (param.getDataType()){
            case Constant.DataType.NUMBER:return new BigDecimal(data.toString());
            case Constant.DataType.STRING:return data.toString();
            case Constant.DataType.BOLL:return Boolean.parseBoolean(data.toString());
            case Constant.DataType.TIME_YMD:return data.toString();
            case Constant.DataType.TIME_HMS:return data.toString();
            case Constant.DataType.TIME_YMDHMS:return data.toString();
        }
        return data;
    }
