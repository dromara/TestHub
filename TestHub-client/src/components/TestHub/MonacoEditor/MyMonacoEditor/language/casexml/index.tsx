  ...
  monaco.languages.registerCompletionItemProvider('casexml', {
    provideCompletionItems: (model, position) => {
      ...
      if (codePreTrim.length > 0) {
        const attr = codePreTrim.substring(codePreTrim.lastIndexOf(' ') + 1, codePreTrim.lastIndexOf('='));
        ...
        if (tag != '<') {
          ...
          if (tag == 'bound' || tag == 'script' || tag == 'flows' || tag == 'params' || tag == 'converts') {
            return {
              suggestions: [{ label: '', insertText: '', detail: '' }],
            };
          }
            ...
            if (word == 'url') {
              ...
              return {
                contents: [
                  ...
                  { value: '**可选值**' },
                  {
                    value: ['POST', 'GET', 'PUT', 'DELETE'].join('\n\n'),
                  },
                ],
              };
            }
            ...
            if (word == 'type') {
              return {
                contents: [
                  ...
                  { value: '**可选值**' },
                  {
                    value: ['none', 'form-data', 'x-www-form-urlencoded', 'raw'].join('\n\n'),
                  },
                ],
              };
          ...
          if (word == 'rule') {
            ...
            return {
              contents: [
                ...
                { value: '**必选参数**' },
                {
                  value: ['code参数;name检查名称;msg异常提示', 'cover被比较对象;threshold比较对象'].join('\n\n'),
                },
              ],
            };
          } else if (word == 'bound') {
            ...
            return {
              contents: [
                ...
                { value: '**必选参数**' },
                {
                  value: ['url请求地址', 'method请求方式'].join('\n\n'),
                },
                { value: '**子组件**' },
                {
                  value: ['headers请求头', 'rests路径参数', 'params参数', 'body请求体'].join('\n\n'),
                },
              ],
            };
          } else if (word == 'rests') {
            ...
            return {
              contents: [
                ...
                { value: '**可选参数**' },
                {
                  value: ['language语言'].join('\n\n'),
                },
                { value: '**子组件**' },
                {
                  value: ['content文本内容', 'param参数'].join('\n\n'),
                },
              ],
            };
