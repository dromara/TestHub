...
if (__UMI_ENV__ === 'local') {
  ...
  @font-face {
    ...
    src: url('//at.alicdn.com/t/c/font_4148545_fbkfdpj1b1f.woff2?t=1706331327427') format('woff2'),
         url('//at.alicdn.com/t/c/font_4148545_fbkfdpj1b1f.woff?t=1706331327427') format('woff'),
         url('//at.alicdn.com/t/c/font_4148545_fbkfdpj1b1f.ttf?t=1706331327427') format('truetype');
  }
  `;
