    ...
    return (
        <>
            <Row
                ...
                className={props.data.flag ? 'log_error' : 'log_success'}
            >
                {props.data != undefined && (
                    <Col className="left_border">
                        <span className={styles.left_top_line}></span>
                        <span className={styles.left_bottom_line}></span>
                    </Col>
                )}
                <Col>
                    <Row>
                        <Col>
                            ...
                            {props.data != undefined &&
                                props.data.operationType?.toLocaleLowerCase() == 'relation' && (
                                    <Row align="middle">
                                        <Col style={{ marginRight: 10 }}>
                                            <Tooltip
                                                title={
                ...
                {props.data != undefined && (
                    <Col className="right_border">
                        <div>
                            <span className={styles.right_top_line}></span>
                            <span className={styles.right_bottom_line}></span>
                        </div>
                    </Col>
                )}
            </Row>
